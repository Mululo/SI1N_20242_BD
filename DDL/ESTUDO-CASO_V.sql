...
CREATE TABLE IF NOT EXISTS FORNECEDORES(
    ...
    DESC_PROD_FORN VARCHAR(200) NOT NULL 
);
...
CREATE TABLE IF NOT EXISTS VENDA(
    ...
    CLIENTE_VENDA VARCHAR(11),
    DATA_VENDA DATE,
    CONSTRAINT FK_CLIENTE_VENDA FOREIGN KEY (CLIENTE_VENDA) REFERENCES CLIENTES(CPF_CLIENTE)
);

CREATE TABLE IF NOT EXISTS PAGAMENTOS(
    ID_PAGAMENTO INT PRIMARY KEY,
    CLIENTE_PAGAMENTO VARCHAR(11),
    DATA_PAGAMENTO DATE NOT NULL,
    VALOR_TOTAL_PAGAMENTO INT NOT NULL, 
