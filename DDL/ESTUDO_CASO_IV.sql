...
CREATE TABLE IF NOT EXISTS AULA(
    ...
    INSTRUTOR_AULA INT,
    ALUNO_AULA INT,
CONSTRAINT FK_E_INSTRUTORES FOREIGN KEY (INSTRUTOR_AULA) REFERENCES INSTRUTORES(ID_INSTRUTOR),
CONSTRAINT FK_E_ALUNO FOREIGN KEY (ALUNO_AULA) REFERENCES ALUNO(ALUNO_CPF)
);
...
CREATE TABLE IF NOT EXISTS PAGAMENTOS(
    ...
    ALUNO_PAGAMENTO INT,
CONSTRAINT FK_ALUNO FOREIGN KEY (ALUNO_PAGAMENTO) REFERENCES ALUNO(ALUNO_CPF)
);
...
CREATE TABLE IF NOT EXISTS PLANO_TREINO(
    ...
    PLANO_INSTRUTOR INT,
    PLANO_ALUNO INT,
CONSTRAINT FK_A_INSTRUTORES FOREIGN KEY (PLANO_INSTRUTOR) REFERENCES INSTRUTORES(ID_INSTRUTOR),
CONSTRAINT FK_A_ALUNO FOREIGN KEY (PLANO_ALUNO) REFERENCES ALUNO(ALUNO_CPF)
);
...
CREATE TABLE IF NOT EXISTS MODALIDADES(
    ...
    INSTRUTOR_MOD INT,
CONSTRAINT FK_B_INSTRUTORES FOREIGN KEY (INSTRUTOR_MOD) REFERENCES INSTRUTORES(ID_INSTRUTOR)
);
