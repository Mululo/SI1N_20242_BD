...
CREATE TABLE IF NOT EXISTS TELEFONES(
    ...
    TIPO_TELEFONE INT,
CONSTRAINT FK_TIPO_TEL FOREIGN KEY(TIPO_TELEFONE) REFERENCES TIPO_TEL(ID_TEL)
);
...
CREATE TABLE IF NOT EXISTS ENDERECO(
    ...
    TIPO_ENDERECO INT,
CONSTRAINT FK_TIPO_END FOREIGN KEY(TIPO_ENDERECO) REFERENCES TIPO_END(ID_TIPO)
);
...
CONSTRAINT FK_TELEFONE FOREIGN KEY(TELEFONE_FORNECEDOR) REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDERECO FOREIGN KEY(ENDERECO_FORNECEDOR) REFERENCES ENDERECO(ID_END)
);
...
CREATE TABLE IF NOT EXISTS COMPONENTES(
    ...
    TIPO_COMP INT,
    FORN_COMP INT,
CONSTRAINT FK_FORNECEDORES FOREIGN KEY (COMP_FORNECEDOR) REFERENCES FORNECEDORES(CNPJ_FORN),
CONSTRAINT FK_TIPOCOMPONENTE FOREIGN KEY(TIPO_COMP) REFERENCES TIPOCOMPONENTE(ID_TC),
CONSTRAINT FK_COMPONENTES FOREIGN KEY(FORN_COMP) REFERENCES COMPONENTES(ID_COMP)
);
...
CONSTRAINT FK_TELEFONEEMP FOREIGN KEY(TELEFONE_EMPRESA) REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDERECOEMP FOREIGN KEY(ENDERECO_EMPRESA) REFERENCES ENDERECO(ID_END)
);
...
CREATE TABLE IF NOT EXISTS PRODUTOS(
    ...
    RE_PROD INT,
    RS_PROD INT,
CONSTRAINT FK_ENCOMENDAS FOREIGN KEY(PROD_ENCOMENDAS) REFERENCES ENCOMENDAS(ID_ENC),
CONSTRAINT FK_COMPONENTESPROD FOREIGN KEY(COMP_ENCOMENDAS) REFERENCES COMPONENTES(ID_COMP),
CONSTRAINT FK_REPROD FOREIGN KEY(RE_PROD) REFERENCES RE(ID_RE),
CONSTRAINT FK_RSPROD FOREIGN KEY(RS_PROD) REFERENCES RS(ID_RS)
);
...
CREATE TABLE IF NOT EXISTS EMPREGADOS(
    ...
    END_EMPREGADO INT,
    EMPREGADO_PROD INT,
CONSTRAINT FK_TELEFONEEMPG FOREIGN KEY(TELEFONE_EMPREGADO) REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDERECOEMPG FOREIGN KEY(END_EMPREGADO) REFERENCES ENDERECO(ID_END),
CONSTRAINT FK_PRODUTOSEMPG FOREIGN KEY(EMPREGADO_PROD) REFERENCES PRODUTOS(ID_PROD)
);
...
CREATE TABLE IF NOT EXISTS CLIENTES(
    ...
    TIPO_TELEFONE INT,
    CLIENTE_ENC INT,
CONSTRAINT FK_TELEFONECLI FOREIGN KEY(TELEFONE_CLIENTE) REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDERECOCLI FOREIGN KEY(END_CLIENTE) REFERENCES ENDERECO(ID_END),
CONSTRAINT FK_TIPO_TELCLI FOREIGN KEY(TIPO_TELEFONE) REFERENCES TIPO_TEL(ID_TEL),
CONSTRAINT FK_ENCOMENDASCLI FOREIGN KEY(CLIENTE_ENC) REFERENCES ENCOMENDAS(ID_ENC)
);
...
CREATE TABLE IF NOT EXISTS MAQUINAS(
    ...
    RM_MAQUINAS INT,
    CONSTRAINT FK_RM FOREIGN KEY(RM_MAQUINAS) REFERENCES RM(ID_RM)
);
